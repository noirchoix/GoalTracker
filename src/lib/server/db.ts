...
async function ensureInit() {
  ...
  db.exec(`
    ...
    CREATE TABLE IF NOT EXISTS task_logs (
      ...
      event_type TEXT NOT NULL CHECK(event_type IN ('note_saved','completed','reopened','audit_failed')),
    ...
    CREATE INDEX IF NOT EXISTS idx_task_logs_user_created ON task_logs(user_id, created_at DESC);
  `);
